...
function assertTheUnexpected(expect) {
  function makeError(err, options) {
    ...
    var assertionErrorOptions = Object.assign({}, options, { message: assertMessage });

    var assertionError = new AssertionError(assertionErrorOptions);
    assertionError.stack = err.stack && err.stack.replace(assertionError.message, assertMessage);
  ...
  return assignObject(function assertTheUnexpected(value, message) {
    ...
    deepStrictEqual: function deepStrictEqual(actual, expected, message) {
      ...
      if (Array.isArray(actual) && Array.isArray(expected)) {
        wrappedExpect(actual, 'to exhaustively satisfy', expected);
      } else {
